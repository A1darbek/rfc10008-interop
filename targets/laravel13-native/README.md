...
- The runner patches the ignored local Dockerfile from `php:8.2-apache` to
  `php:8.3-apache` because the pinned Laravel 13 lockfile requires PHP `^8.3`.
